...
const createProfile = asyncHandler(async(req,res)=>{
    ...
    return res.status(201).json(new ApiResponse(201,'Delivery partner created successfully',deliveryPartner))
});
...
const assignPartner = asyncHandler(async(req,res)=>{
    ...
    return res.status(200).json(new ApiResponse(200,'Delivery partner assigned successfully',order))
...
const viewAllOrders = asyncHandler(async(req,res)=>{
    ...
    if(orders.length === 0){
        return res.status(200).json(new ApiResponse(200,'No orders to show',orders))
    }
...
const pickUpOrder = asyncHandler(async(req,res)=>{
    ...
    return res.status(200).json(new ApiResponse(200,'Order Picked up successfully',order))
...
const deliverOrder = asyncHandler(async(req,res)=>{
    ...
    return res.status(200).json(new ApiResponse(200,'delivered successfully',order))
